...
driveRight.whenPressed(new DriveForward() ,true);
    SmartDashboard.putData("DriveRight",new DriveForward() );

final JoystickButton driveLeft = new JoystickButton(driveShoot, XboxController.Button.kStickLeft.value);        
driveLeft.whenPressed(new DriveForward() ,true);
    SmartDashboard.putData("DriveLeft",new DriveForward() );
