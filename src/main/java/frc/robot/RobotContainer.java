...
private final XboxController driveShoot = new XboxController(0);
  ...
  */
  private RobotContainer() {
    ...
    SmartDashboard.putData("DriveForward", new DriveForward(m_driveTrain));
...
ballIntake.whileHeld(new Intake() ,true);
    SmartDashboard.putData("Ball Intake",new Intake() );
...
driveRight.whenPressed(new DriveForward(m_driveTrain) ,true);
    SmartDashboard.putData("DriveRight",new DriveForward(m_driveTrain) );

final JoystickButton driveLeft = new JoystickButton(driveShoot, XboxController.Button.kStickLeft.value);        
driveLeft.whenPressed(new DriveForward(m_driveTrain) ,true);
    SmartDashboard.putData("DriveLeft",new DriveForward(m_driveTrain) );
